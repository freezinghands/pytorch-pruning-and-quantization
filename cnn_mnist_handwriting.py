...
layers = list()
layers.append(tf.keras.layers.InputLayer(input_shape=(28, 28)))
layers.append(tf.keras.layers.Reshape(target_shape=(28, 28, 1)),)
layers.append(tf.keras.layers.Conv2D(filters=12, kernel_size=(3, 3), activation='relu'))
...
for tensor_details in interpreter.get_tensor_details():
    ...
    np.save(os.path.join(intermediate_output_dirname, f"cnn_mnist_{tensor_name}"), tensor)
