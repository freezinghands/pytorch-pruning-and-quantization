...
import torch_mnist_lenet as modelfile  # modelfile selection
...
model = modelfile.LeNet5()  # generate model of modelfile
...
# prune.random_unstructured(model.conv1, "weight", amount=prune_amount)
# prune.random_unstructured(model.conv1, "bias",   amount=prune_amount)
# prune.random_unstructured(model.conv2, "weight", amount=prune_amount)
# prune.random_unstructured(model.conv2, "bias",   amount=prune_amount)
# prune.random_unstructured(model.conv3, "weight", amount=prune_amount)
# prune.random_unstructured(model.conv3, "bias",   amount=prune_amount)
# prune.random_unstructured(model.fc1, "weight", amount=prune_amount)
# prune.random_unstructured(model.fc1, "bias",   amount=prune_amount)
# prune.random_unstructured(model.fc2, "weight", amount=prune_amount)
# prune.random_unstructured(model.fc2, "bias",   amount=prune_amount)
prune.l1_unstructured(model.conv1, "weight", amount=prune_amount)
prune.l1_unstructured(model.conv1, "bias",   amount=prune_amount)
prune.l1_unstructured(model.conv2, "weight", amount=prune_amount)
prune.l1_unstructured(model.conv2, "bias",   amount=prune_amount)
prune.l1_unstructured(model.conv3, "weight", amount=prune_amount)
prune.l1_unstructured(model.conv3, "bias",   amount=prune_amount)
prune.l1_unstructured(model.fc1, "weight", amount=prune_amount)
prune.l1_unstructured(model.fc1, "bias",   amount=prune_amount)
prune.l1_unstructured(model.fc2, "weight", amount=prune_amount)
prune.l1_unstructured(model.fc2, "bias",   amount=prune_amount)
...
qconfig = torch.quantization.get_default_qconfig('qnnpack')  # set Qconfig - maybe static??
...
target_model.conv1.register_forward_hook(make_hook(f'{output_modelname}_conv1'))
target_model.conv2.register_forward_hook(make_hook(f'{output_modelname}_conv2'))
